...
export const formatGroupLabel = (group: GroupBase<SelectOption>) => <div>{group.label}</div>
  ...
  option: (styles, { isDisabled, isFocused, isSelected }) => {
    return {
      ...
      backgroundColor: isDisabled
        ...
        ? theme.grey20
        : theme.grey20,
      borderLeft: isSelected ? `5px solid ${theme.lochivarAccent3}` : `5px solid transparent`,
